  ...
  const workLogs: WorkLog[] = [
    {
      ...
      categoryId: 'demo', clientId: clientIdMap.bigdata, projectId: projIdMap.smartcity,
    ...
    },
    {
      ...
      categoryId: 'client_visit', clientId: clientIdMap.emergency, projectId: projIdMap.emergency,
    ...
    },
    {
      ...
      categoryId: 'meeting', clientId: null, projectId: null,
      createdAt: iso(daysAgo(1)), updatedAt: iso(daysAgo(1))
    },
    {
      id: id('log', 4), date: daysAgo(2),
      content: '全天在省交通集团驻场调研，访谈信息化管理部陈总及下属三个业务处室负责人。梳理出智慧高速、智慧港口、智慧物流三条业务线的数字化痛点，形成初步需求清单。',
      categoryId: 'requirement', clientId: clientIdMap.transport, projectId: projIdMap.transport,
    ...
    },
    {
      ...
      categoryId: 'solution', clientId: clientIdMap.bigdata, projectId: projIdMap.smartcity,
    ...
    },
    {
      ...
      categoryId: 'client_visit', clientId: clientIdMap.edu, projectId: projIdMap.edu,
    ...
    },
    {
      ...
      categoryId: 'tech_exchange', clientId: null, projectId: projIdMap.cloud,
    ...
    },
    {
      ...
      categoryId: 'bidding', clientId: clientIdMap.emergency, projectId: projIdMap.emergency,
      createdAt: iso(daysAgo(5)), updatedAt: iso(daysAgo(5))
    },
    {
      id: id('log', 9), date: daysAgo(6),
      content: '出差省城参加省交通集团数字化转型项目启动会。会议明确项目组织架构、里程碑计划和汇报机制。会后与陈总团队共进晚餐，进一步沟通项目预期。',
      categoryId: 'travel', clientId: clientIdMap.transport, projectId: projIdMap.transport,
    ...
    },
    {
      ...
      categoryId: 'competitive', clientId: null, projectId: projIdMap.smartcity,
    ...
    },
    {
      ...
      categoryId: 'coordination', clientId: clientIdMap.health, projectId: projIdMap.health,
    ...
    },
    {
      ...
      categoryId: 'training', clientId: null, projectId: null,
    ...
    },
    {
      ...
      categoryId: 'approval', clientId: clientIdMap.bigdata, projectId: projIdMap.smartcity,
    ...
    },
    {
      ...
      categoryId: 'solution', clientId: clientIdMap.transport, projectId: projIdMap.transport,
    ...
    },
    {
      ...
      categoryId: 'demo', clientId: clientIdMap.smartcity, projectId: null,
    ...
    },
    {
      ...
      categoryId: 'coordination', clientId: null, projectId: projIdMap.cloud,
    ...
    },
    {
      ...
      categoryId: 'meeting', clientId: clientIdMap.bigdata, projectId: projIdMap.smartcity,
